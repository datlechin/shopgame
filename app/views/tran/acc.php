                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="id" placeholder="Mã tài khoản game"
                                       value="">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                ...
                                <input type="date" class="form-control" name="started_at" autocomplete="off"
                                       placeholder="Từ ngày"
                                       value="<?php echo (isset($_GET['started_at'])) ? $_GET['started_at'] : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="started_at"><i class="fa fa-calendar"></i></span>
                                <input type="date" class="form-control" name="ended_at" autocomplete="off"
                                       placeholder="Đến ngày"
                                       value="<?php echo (isset($_GET['ended_at'])) ? $_GET['ended_at'] : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <?php if (count($accounts) > 0): ?>
                            <?php foreach ($accounts as $account): ?>
                                <tr>
                                    ...
                                    <td><a href="/tran/acc/<?= $account['id'] ?>" class="btn btn-info">Xem</a></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
